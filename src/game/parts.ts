...
export const CANNONS: Record<string, CannonPart> = {
  mg: { name: 'Пулемёт', desc: 'Слабо, но очень часто', dmg: 4, reload: 120, bspeed: 9, blen: 30, bw: 5, bullet: 3 },
  gun: { name: 'Пушка', desc: 'Сбалансированный выстрел', dmg: 16, reload: 620, bspeed: 8, blen: 40, bw: 8, bullet: 5 },
  howitzer: { name: 'Гаубица', desc: 'Бьёт больно, но редко', dmg: 34, reload: 1450, bspeed: 6, blen: 30, bw: 13, bullet: 8 },
};
...
export function defaultConfig() {
  return { country: 'rud', tracks: 'medium', turret: 'small', cannon: 'gun', hull: 'standard' };
}
